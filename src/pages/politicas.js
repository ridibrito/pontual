    ...
    <>
      <div className="p-12">
        ...
        <p className="px-12 mt-12">
          A sua privacidade é importante para nós. É política do Pontual Planos
          de saúde respeitar a sua privacidade em relação a qualquer informação
          sua que possamos coletar no site Pontual Planos de saúde, e outros
        ...
        <p className="px-12 mt-4">Compromisso do Usuário</p>
        <p className="px-12 mt-4">
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o Pontual Planos de saúde oferece no site e com caráter
        ...
        <div className="px-12 mt-4 ml-12">
          ...
          <li>
            ...
            (softwares) do Pontual Planos de saúde, de seus fornecedores ou
        ...
        <p className="px-12 mt-4">Mais informações</p>
        <p className="px-12 mt-4">
        ...
        <p className="px-12 mt-4">
          Esta política é efetiva a partir de 12 April 2024 09:14
        </p>
      </div>
      <Footer />
    </>
